  ...
  const handleSearch = (e) => {
    ...
    return (
        <div className='container'>
         <div className='quatehistory'>
            <div className=" d-flex justify-content-between align-items-center py-5">
                <div className="headding">
                    <h3 className='text-danger'>Quate Histry</h3>
                </div>
                <div className="search quate">
                ...
                <Modal show={show} onHide={handleClose} className='bookinglismodal'>
                    <div className="updatemodal">
                        <form onSubmit={handleSubmit(onSubmit)} className="updateorderform">
                            ...
                            <input defaultValue={iddata.platform} {...register("platform", { required: true })} placeholder='product name' /><br />
                            <input defaultValue={iddata.collectionPascode} {...register("collectionPascode", { required: true })} placeholder='Price' /><br />
                            <input defaultValue={iddata.miles} {...register("miles", { required: true })} placeholder="Miles" /><br />
                            <input defaultValue={iddata.expactime_date} {...register("expactime_date", { required: true })} placeholder="user Email" /><br />
...
export default UserQuateHistry;