...
const Areas = () => {
    ...
    const onSubmit = data => {
     fetch(`http://localhost:5000/homeArea/${data._id}`,{
        method:'PUT',
        headers:{
        ...
        <div className='text-dark py-3'>
            <Container>
                ...
                <div className="areas-section ">
                    <h5 className='text-dark'>Areas</h5>
                    {
                        homearea.map(item=><form key={item._id} onSubmit={handleSubmit(onSubmit)} className='mobiledevice p-3'>
